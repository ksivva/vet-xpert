        ...
        if (animalData) {
          ...
          if (deathRecord) {
            ...
            setFormData({
              ...
              image: null // We can't download the file directly, but we'll show it if available
            });
            
            // If there's an existing image, show it
            if (deathRecord.imageUrl) {
              setImagePreview(deathRecord.imageUrl);
            }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 flex items-center gap-4">
                <label className="cursor-pointer flex items-center gap-2 text-sm border border-gray-300 rounded-md px-4 py-2 bg-white hover:bg-gray-50">
                  <Camera size={18} />
                  <span>{formData.image || imagePreview ? 'Change Photo' : 'Upload Photo'}</span>
                  <Input
                    id="image"
                    type="file"
                    accept="image/*"
              ...
              {imagePreview && (
                <div className="mt-4">
                  <div className="border border-gray-200 rounded-md overflow-hidden w-40 h-40">
                    <img 
                      src={imagePreview} 
                      alt="Death documentation" 
